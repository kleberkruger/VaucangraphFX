 ...
 * @author manuel.mauky
 */
public class ViewLoaderReflectionUtils extends de.saxsys.mvvmfx.internal.viewloader.ViewLoaderReflectionUtils {

    /**
     * Returns the {@link Field} of the viewModel for a given
     ...
     * @param newVmConsumer a Consumer function that is applied when a new ViewModel
     *                      instance is created.
     * @throws RuntimeException if there is a ViewModel field in the View with the
     ...
     *
     * @param view            the view instance that is used to find out the type of the
     *                        ViewModel
     ...
     *
     * @param viewModel       the viewModel that's initialize method (if available) will be
     *                        invoked.
     * @param <ViewModelType> the generic type of the ViewModel.
     */
