...
package br.com.mvvmfx.viewloader;

import br.com.mvvmfx.viewloader.internal.FxmlViewLoader;
 ...
 * @author manuel.mauky
 */
public class ModularViewLoader {

    /**
     * This class is the builder step to load a java based view. It is accessed
     * from the {@link ModularViewLoader} with the method
     * {@link ModularViewLoader#javaView(Class)}.
     *
     ...
     * from the {@link ModularViewLoader} with the method
     * {@link ModularViewLoader#fxmlView(Class)}.
     *
     * @param <ViewType>      the generic type of the View that should be loaded. This type
